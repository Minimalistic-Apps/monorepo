...
describe(AddCurrencyScreenPure.name, () => {
    ...
    test('filters currencies by territory name', async () => {
    ...
    test('filters currencies by partial territory name', async () => {
        const user = userEvent.setup();
        const { AddCurrencyScreen } = createTestComponent();

        render(<AddCurrencyScreen />);

        // "Liech" should match Liechtenstein which uses CHF
        await user.type(
            screen.getByPlaceholderText('Search currencies...'),
            'Liech',
        );
    ...
    test('filters currencies by currency code', async () => {
        const user = userEvent.setup();
        const { AddCurrencyScreen } = createTestComponent();
    ...
    test('filters currencies by currency name', async () => {
        const user = userEvent.setup();
        const { AddCurrencyScreen } = createTestComponent();
    ...
    test('shows empty state when no currencies match', async () => {
        const user = userEvent.setup();
        const { AddCurrencyScreen } = createTestComponent();
    ...
    test('territory search finds EUR when searching for Germany', async () => {
        const user = userEvent.setup();
        const { AddCurrencyScreen } = createTestComponent();
